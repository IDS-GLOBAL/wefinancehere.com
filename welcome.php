	...
	<section class="wrapper-md">
		<div class="container">
            ...
            <div class="row">
                    ...
                    <h2><i class="fa fa-facebook-official text-primary"></i> Login With Facebook To Personlize Your Experience. <span class="text-muted">The best auto</span> deals online.</h2>
                ...
                <div class="col-sm-6">
                	<p><a id="view_quality_cars" class="btn btn-lg btn-primary">View Quality (Cars) <i class="fa fa fa-car"></i></a></p>
                </div>
                <div class="col-sm-6">
                	<p><a  id="view_bhph_cars" class="btn btn-lg btn-primary"><i class="fa fa fa-car"></i> View BuyHere Pay Here (Cars)</a></p>
                </div>
            </div>
...
<div id="view_choices_box" class="row">
    <div class="col-md-6" style="display:block;">
        <button id="lockin_preapproval" type="button" class="btn btn-success btn-lg btn-block col-md-6">LOCK IN MY PRE-APPROVAL</button>
    </div><!-- /.col -->
    
    <div class="col-md-6" style="display:block;">
        <button id="shop_only" type="button" class="btn btn-primary btn-lg btn-block col-md-6">LET ME TAKE A PEEK FIRST</button>
    </div><!-- /.col -->
...
<div id="register_myapproval_box" style="display:none;">
	...
	<br class="spacer-sm">
            ...
            <button id="allocate_funds" type="button" class="btn btn-facebook btn-block btn-lg">Confirm My <span id="need_amountt">$ 0</span> Pre-Approval!</button>
        </div>
	</div>
...
<section class="wrapper-lg bg-highlight" id="pricing">
        ...
        <div class="container">
			<h2 class="text-center">What You Can Expect About Rates <small>based on previous deals done on a national research.</small></h2>
			<br class="spacer-lg">
			<div class="row">
				<div class="col-md-4">
					<div class="plan">
