...
$post_vid = mysqli_real_escape_string($wfh_connection_mysqli, trim($_POST['vid']));
$post_vdescript_txt = mysqli_real_escape_string($wfh_connection_mysqli, trim($_POST['vdescript_txt']));
$post_budget_afford = mysqli_real_escape_string($wfh_connection_mysqli, trim($_POST['budget_afford']));
$post_gross_monthincome = mysqli_real_escape_string($wfh_connection_mysqli, trim($_POST['gross_monthlyincome']));
$post_cust_creditapr = mysqli_real_escape_string($wfh_connection_mysqli, trim($_POST['cust_creditapr']));
$post_cust_creditapr_txt = mysqli_real_escape_string($wfh_connection_mysqli, trim($_POST['cust_creditapr_txt']));

//$wfhuserperm_id = mysqli_real_escape_string($wfh_connection_mysqli, trim($_POST['wfhuserperm_id']));

$post_wfhuserperm_token = mysqli_real_escape_string($wfh_connection_mysqli, trim($_POST['wfhuserperm_token']));
$post_wfhuser_id = mysqli_real_escape_string($wfh_connection_mysqli, trim($_POST['wfhuser_id']));

$wfhuserid_matched = 'N';

if($post_wfhuser_id == $wfhuser_id){ $wfhuserid_matched = 'Y'; }

$post_wfhuserperm_approval_id = mysqli_real_escape_string($wfh_connection_mysqli, trim($_POST['wfhuser_approval_id']));
$post_wfhuserperm_approval_fname = mysqli_real_escape_string($wfh_connection_mysqli, trim($_POST['wfhuserperm_approval_fname']));
$post_wfhuserperm_approval_lname = mysqli_real_escape_string($wfh_connection_mysqli, trim($_POST['wfhuserperm_approval_lname']));

$post_wfhuserperm_approval_email = mysqli_real_escape_string($wfh_connection_mysqli, trim($_POST['wfhuserperm_approval_email']));
$post_wfhuserperm_approval_phone = mysqli_real_escape_string($wfh_connection_mysqli, trim($_POST['wfhuserperm_approval_phone']));
$post_wfhuserperm_fbid =  mysqli_real_escape_string($wfh_connection_mysqli, trim($_POST['wfhuserperm_fbid']));


//$wfhuserperm_appointment_id = $row_wfhuserperm_approval_lname['wfhuserperm_appointment_id'];

$post_wfhuserperm_appointment_timezone = mysqli_real_escape_string($wfh_connection_mysqli, trim($_POST['wfhuserperm_appointment_timezone']));
...
$find_exstwfhuser_vlike = mysqli_query($wfh_connection_mysqli, $query_find_exstwfhuser_vlike);
...
$query_wfhuser_like_withdlrvehicle_sql = mysqli_query($wfh_connection_mysqli, $update_wfhuser_like_withdlrvehicle_sql);
