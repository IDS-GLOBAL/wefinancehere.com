...
<!-- End Modals -->
	...
	<section class="wrapper-md bg-primary" id="vehicle_locations">
        ...
        <div class="row">
        	<div class="col-sm-3 has_idle">
							  <label for="dma_state">Your State:</label>
									<select id="dma_state" class="form-control" title='Choose One' data-style="btn-primary">
...
<option value="10000" <?php if (10000 == $row_find_existingsession_approval['wfhuser_approval_month_income']){ echo "selected=\"selected\"";} ?>>$10,000 - $10,000 (+)Plus</option>
        	...
        	<div class="col-sm-3 has_idle">
									...
									<select id="max_car_payment" class="form-control" title='$50 Car Payment' data-style="btn-primary">
...
google.maps.event.addDomListener(window, 'load', initialize);
	...
	<section class="wrapper-md">
		<div class="container">
            ...
            <div class="row">
            	<div class="col-sm-12 text-center">
                	<div class="btn btn-default btn-block" onclick="login()"><h2><i class="fa fa-facebook-official"></i> Peronalize Your Experience</h2></div>
                </div>
            </div>
		</div><!-- /.container -->
	</section>
