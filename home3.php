...
<!-- script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCYwsd0NKRysnUVB7BOi-4lRd7cq1QwS6Y&language=eng"></script 11.30.2019 /wefinancehere@gmail.com --> 
</head>
...
<!-- End Modals -->
	...
	<section class="wrapper-md bg-primary" id="vehicle_locations">
        ...
        <div class="col-sm-12">
            ...
            <div  id="budget_box" class="row" style="">
              <div class="col-sm-12">
            	<div class="col-sm-12 wow slideInLeft" data-wow-delay="1s">
...
<option value="YES" <?php if ("YES" == $row_find_existingsession_approval['wfhuser_approval_openloan']){ echo "selected=\"selected\"";} ?>>YES</option>
            ...
            <div id="map_box" class="row">
              <div class="">
            	<div class="">
              			...
              			<br class="spacer-lg">
                                <div class="row wow slideInRight m-r-10" data-wow-delay="2s">
                    ...
                    */
                    ...
                    google.maps.event.addDomListener(window, 'load', initialize);
						...
						<h2 class="text-center headline">WFH Approval Locations</h2>                
                </div>
              </div>
            </div>
	...
	<section class="wrapper-md">      
		...
		<div class="container overlay-bg">
			<div class="row">
              ...
              <br class="spacer-lg">
				...
				<div class="col-sm-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.20s">
                
                <h2>Finding Your Deal Is Just A Button Away</h2>
                    <p class="lead">We have access to dealers nationwide we give you easy access to take the next step towards ownership with the right vehicle at the best location.</p>
                    <p>No worries about how much your next vehicle is going to cost you.  We have taking the time and made it easy just for you.</p>
                    
                
                </div>
				
				<div class="col-sm-6 wow pulse" data-wow-iteration="infinite" data-wow-duration="1500ms"> <a href="states.php" target="_parent"><img class="img-responsive" src="assets/img/buy-a-nicecar.png" alt=""></a>
                    <br class="spacer-lg">
				</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-6 wow slideInDown" data-wow-duration="1s" data-wow-delay="0.3s">
					<img class="img-responsive" src="assets/img/red-car-shopping-cart.jpg" alt="">
				</div>
                ...
                <h2>Easy Approvals For Everyone Quick And Easy</h2>
                    ...
                    <p class="lead">See Listings by down payment / monthly prices.</p>
                    <p class="lead">View vehicles with your pre-approval today.</p>
		...
		<div class="container">
			<div class="row">
                ...
                <h2>Finance Your Next Car From Here</h2>
                    <p class="lead">We have put together vehicles from various dealers with easy finance options just for you.  Regardless of credit, we can help you find the right vehicle at the right dealership.  We specialize in all types of credit Good, Bad, Slow, And Even Excellent Credit. We provide you direct access to each vehicle at one of our approval locations.</p>
                    <p class="lead">See Listings by down payment / monthly prices.</p>
                    <p class="lead">View vehicles with your pre-approval today.</p>
				...
				<div class="col-sm-6 wow bounceInRight" data-wow-duration="1s" data-wow-delay="0.3s">
					<img class="img-responsive" src="assets/img/finance-a-car-online.jpg" alt="">
				</div>
	...
	<section class="wrapper-md">
		<div id="dstore_listing_result" class="container" style="display:none;">
	...
	<section class="wrapper-md">
		<div id="vlisting_result" class="container" style="display:none;">
