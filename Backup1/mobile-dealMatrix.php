...
<div data-role="page">
				...
				<div id="jqm-homeheader" class="ui-mobile">
                    ...
                    <h1>WeFinanceHere.com &quot;Mobile Friendly Credit Application&quot;</h1>
                    
                    <h1 id="jqm-logo">
                      <img src="images/wfh_logo.png" alt="" />
                    </h1>
					
                    <p>
                    	<strong>Touch Screen-Optimized For Mobile Web, Smartphones, &amp; Tablets</strong>
                    </p>
...
<select name="titleName" id="titleName"  data-native-menu="false">
			...
			<div data-role="fieldcontain">
	         ...
	         <input type="text" name="MiddleName" id="MiddleName" value="" placeholder="Middle Name Or Initial:" />
			</div>
...
<div data-role="fieldcontain">
		<label for="Suffix" class="select">Suffix:</label>
			...
			<div data-role="fieldcontain">
	         ...
	         <input name="Phone" type="text" id="Phone" value=""  placeholder="Mobile Phone:" />
			</div>
          
		  	<div data-role="fieldcontain">
	         <label for="Address1">Address 1:</label>
        	 <textarea name="Address1" cols="40" rows="3" id="Address1" placeholder="Address 1:"></textarea>
			</div>
			<div data-role="fieldcontain">
	         <label for="Address2">Address 2:</label>
	         <input type="text" name="Address2" id="Address2" value=""  placeholder="Address 2:" />
		  	</div>
			<div data-role="fieldcontain">
		  ...
		  <div data-role="fieldcontain">
	         ...
	         <input type="text" name="County" id="County" value="" placeholder="County:" />
		  </div>
			...
			<div data-role="fieldcontain" id="PreviousWorkHistory">
	         <label for="PreviousWorkHistory">Previous Work History:</label>
		  </div>

			<div data-role="fieldcontain">
			<label for="2Address1">Previous Address 1:</label>

			<input name="2Address1" id="2Address1" size="17">
			</div>            
            
			<div data-role="fieldcontain" id="2Address2">
			<label for="2Address2">Previous Address 2:</label>
            <input name="2Address2" id="2Address2" size="17">
			</div>
            
			<div data-role="fieldcontain" id="2City">
			<label for="2City">Previous City:</label>
            <input name="2City" id="2City" size="6">
			</div>
            
			<div data-role="fieldcontain" id="2State">
			<label for="2State">Previous State:</label>
            <select name="2State" id="2State" data-native-menu="false">
              <option value="">Select State</option>
              <?php
do {  
?>
...
?>
			...
			<div data-role="fieldcontain">
			<label for="2Zip">Previous Zip:</label>
			<input name="2Zip" id="2Zip" size="4">
            
			</div>
            
			<div data-role="fieldcontain">
			<label for="2County">Previous State:</label>
            <input name="2County" id="2County" size="11">
			</div>            
            
			<div data-role="fieldcontain">
			<label for="2LiveYears">Previous Live Years:</label>
			...
			<div data-role="fieldcontain">
			<label for="2LiveMonths">Previous Live Months:</label>
            <select name="2LiveMonths" id="2LiveMonths">
                <option value="">Select Months</option>
                <option value="0 Months">0 Months</option>
                <option value="1 Month">1 Month</option>
                <option value="2 Months">2 Months</option>
		...
		<div data-role="fieldcontain" id="PreviousWorkHistory">
          ...
          <div data-role="fieldcontain">
	         ...
	         <input type="text" name="EmployerName" id="EmployerName" value="" placeholder="Employer Name:" />
		  </div>

			<div data-role="fieldcontain">
	         <label for="EmployerPhoneNo">Work Number:</label>
	         <input type="text" name="EmployerPhoneNo" id="EmployerPhoneNo" value="" placeholder="Work Number:"  />
		  </div>
          ...
          <div data-role="fieldcontain">
			...
			<div data-role="fieldcontain">
			  <label for="paydayFreq">How Often Do You Get Paid:</label>
			  <select name="paydayFreq" id="paydayFreq" data-native-menu="false">
		...
		<div data-role="fieldcontain">
			  <label for="applicant_employer2_name">Previous Employer Name:</label>        
          <input name="applicant_employer2_name" id="applicant_employer2_name" size="25">
		 </div>         

		<div data-role="fieldcontain">
			  <label for="applicant_employer2_phone">Previous Employer Phone Number:</label>                  
          <input name="applicant_employer2_phone" type="text" id="applicant_employer2_phone" size="15">
		</div>

		<div data-role="fieldcontain">
			  <label for="applicant_employer2_addr">Previous Employer Address 1:</label>                            
          <input name="applicant_employer2_addr" id="applicant_employer2_addr" size="15">
		</div>

			<div data-role="fieldcontain">
			  <label for="applicant_employer2_addr2">Previous Employer Address 2:</label>                                      
          <input name="applicant_employer2_addr2" id="applicant_employer2_addr2" size="15">
</div>

			<div data-role="fieldcontain">
			  <label for="applicant_employer2_zip">Previous Employer Zip:</label>
          <input name="applicant_employer2_zip" type="text" id="applicant_employer2_zip" size="5">
</div>

			<div data-role="fieldcontain">
			  <label for="applicant_employer2_city">Previous Employer City:</label>
          <input name="applicant_employer2_city" type="text" id="applicant_employer2_city" size="10">
</div>          
          
			<div data-role="fieldcontain">
			  <label for="applicant_employer2_state">Previous Employer State:</label>          
          <select name="applicant_employer2_state" id="applicant_employer2_state" data-native-menu="false">>
...
?>
			...
			<div data-role="fieldcontain">
	         ...
	         <input type="text" name="ssn" id="ssn" value="" placeholder="i.e. 123-45-6789" />
		  </div>
          ...
          <div data-role="fieldcontain">
                ...
                Slide Year &nbsp; =
			 	...
			 	<input type="range" name="cbirth_year" id="cbirth_year" value="0" min="1900" max="1995"  />
		  </div>
