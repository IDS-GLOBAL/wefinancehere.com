...
<div class="proFileIntro">                
	...
	<div id="divSocialShare">
        ...
        <?php //include("Prototype Fisheye_default.php"); ?> 

        <br />

		<a href="#">
        <img src="images/facebook_button.png" width="72px" />
        </a>
        

		<a href="javascript:hideshow(document.getElementById('CreditProfileBox'))">Apply For Financing</a>                 
      <br />
   
<br />

        <!--br />
        <a  href="#">Share With Friend</a>

        <a  href="#">Print Brochure</a>
        <br />
        ...
        <a  href="#">Coming Soon</a-->
                    <div>
                        ...
                        <?php echo $row_slctVehicle['vcomments']; ?>
                    </div>
