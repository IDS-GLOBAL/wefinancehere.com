					 ...
					 <table width="100%">
                      <tr>
						...
						<ul>
							...
							<li><strong>Trans.:</strong> <?php echo $row_slctVehicle['vtransm']; ?></li>
...
<div class="proFileIntro">                
				...
				<?php include("inc/thumbnailsBox.php"); ?><!--proFileDesc-->
                
				<div class="header2">
					Get Approved Right Here Right Now!
				</div><!--header2-->
                
				<div class="proFileDesc">
					<div class="proFileBullets">
						<ul>
							<li>Got A Down Payment or Trade?</li>
							<li>Got A Job?</li>
							<li>Got A Valid Driver Licenses?</li>
							<li>No Credit, Bad Credit,  Don't Sweat It!</li>                            
						</ul>
                        Click Get Started Below To Get Pre Approved.
					</div><!--proFileBullets-->
				</div><!--proFileDesc-->
	  ...
	  <div class="ApproveME">
					<a href="javascript:hideshow(document.getElementById('CreditProfileBox'))"></a>                  
				</div><!--loanqualifyME-->
        ...
        This is just some font that i'm typing to see what's really going on here? 
        This is just some font that i'm typing to see what's really going on here? 
        This is just some font that i'm typing to see what's really going on here? 

        <br />

		<a href="#">divSocialShare</a></div><!--divSocialShare-->

        
	  <div class="dividingSpaceBar">
			Get Approved Today Up To $50,000 In Just Seconds before You Apply! This is just some font that i'm typing to see what's really going on here?
	  ...
	  <form action="scriptDealMatrix.php" name="FormDealMatrix" id="FormDealMatrix" style="margin:0; padding:0;">
            ...
            <div id="CreditProfileBox" style="display: none;">
