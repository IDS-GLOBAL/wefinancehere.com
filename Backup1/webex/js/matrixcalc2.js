...
MatrixMinimumAmt[1] = trypricetwo
MatrixMinimumAmt[2] = trypricethree
MatrixMinimumAmt[3] = trypricefour
MatrixMinimumAmt[4] = trypricefive
...
function popOutThisOffer(aff_id,sub_id,link_id,page_id,page_zone_id)
{
	...
	host = 'https://www.financialeducationservices.com';
	
	url = '/learn_more_uces.aspx?rid=';	
	url = url + 'CBenjamin3';
