<div class="vwrapper">
                            ...
                            <div class="extra-box">
                                ...
                                <div class="padding-top">
                                  ...
                                  <h2><?php echo $Vehiclescompany; ?></h2>
                                        <br />
                                        <b>Call Us Now: </b>Login In With Facebook To Get Number<br />						
                <!--
                ...
                -->
                                        <br />
                                        <address>
                                        Login With Faceboock For Address<br />
                                    ...
                                    <p>
                                        ...
                                        <strong>Rgester To Call</strong>
                                        </a>
                                    
                                        |
                                        <a id="button3" href="<?php //echo $Vehiclesvid; ?>">
                                          <strong>Register To Request A Call</strong>
                                        </a>
                                        |
                                        <a id="button4" href="<?php //echo $Vehiclesvid; ?>">
                                          <strong>Register For Appointment</strong>
                                        </a>
