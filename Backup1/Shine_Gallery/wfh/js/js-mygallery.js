$(document).ready(function()
  {
	 ...
	 var default_image = 'images/WeFinacehere-Orange-Logo-640x480.png';
	 var default_caption = 'Vehicle Photo Preview';
	 ...
	 $('#largephoto').hover(function()
	 {
		...
		largeCaption.fadeIn()
         ...
         largeCaption.find('.captionShine').css("background-position","-640px 0"); 
         largeCaption.find('.captionShine').animate({backgroundPosition: '640px 0'},700);
