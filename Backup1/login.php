...
mysqli_select_db($idsconnection_mysqli, $database_idsconnection);
$query_qryusedmarkets = "SELECT * FROM states, markets_dm WHERE states.state_id =  markets_dm.state_id";
$qryusedmarkets = mysqli_query($idsconnection_mysqli, $query_qryusedmarkets);
$row_qryusedmarkets = mysqli_fetch_assoc($qryusedmarkets);
$totalRows_qryusedmarkets = mysqli_num_rows($qryusedmarkets);
...
mysqli_free_result($qryusedmarkets);
?>
