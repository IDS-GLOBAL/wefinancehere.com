...
<html>
	<head>
	<title>WeFinanceHere - Interview Complete</title>
	<meta charset="utf-8">
		...
		<?php include("_top_navigation.php"); ?>			
            ...
            <div class="body content rows scroll-y">
				...
				<div class="jumbotron bg-white sm">
				  <h1>Congratulations Your Interview Is Complete!</h1>
				  <p><a class="btn btn-success btn" role="button"><i class="fa fa-plus-circle"></i> Go To Dashboard</a></p>
				</div>
